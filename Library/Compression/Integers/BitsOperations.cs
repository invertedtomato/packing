...
public static class BitOperation
{
    ...
    /// <summary>
    /// Add bits to the end of a buffer
    /// </summary>
    ...
    public static void Enqueue(ref UInt64 targetBuffer, ref Int32 targetCount, UInt64 buffer, Int32 count)
    {
    ...
    /// <summary>
    /// Take bits off the start of the buffer
    /// </summary>
    /// <param name="targetBuffer"></param>
    /// <param name="targetCount"></param>
    /// <param name="count"></param>
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UInt64 Dequeue(ref UInt64 targetBuffer, ref Int32 targetCount, Int32 count)
    {
