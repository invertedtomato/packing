...
namespace InvertedTomato.Compression.Integers.Tests {
    ...
    public class EliasOmegaUnsignedReaderTests {
        private ulong Read(string input) {
            return EliasOmegaUnsignedReader.ReadOneDefault(BitOperation.ParseToBytes(input));
        }
        ...
        public void Read_2_2_2() {
            using (var stream = new MemoryStream(BitOperation.ParseToBytes("11011011 00000000"))) {
