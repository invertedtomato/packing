...
namespace InvertedTomato.Compression.Integers.Tests {
    ...
    public class EliasDeltaUnsignedReaderTests {
        private ulong Read(string input) {
            return EliasDeltaUnsignedReader.ReadOneDefault(ByteArrayUtility.ParseBinaryString(input));
        }
        ...
        public void Read_2_2_2() {
            using (var stream = new MemoryStream(ByteArrayUtility.ParseBinaryString("01010101 01010000"))) {
        ...
        public void Read_15_15_15() {
            using (var stream = new MemoryStream(ByteArrayUtility.ParseBinaryString("00101000 00010100 00001010 00000000"))) {
                using (var reader = new EliasDeltaUnsignedReader(stream)) {
